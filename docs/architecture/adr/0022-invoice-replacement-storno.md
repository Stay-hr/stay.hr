...
- Admin API: [backend/apps/api/admin_invoice_replacement_views.py](../../../backend/apps/api/admin_invoice_replacement_views.py) — `HasScope` `admin:read` / `admin:write`; `reception:*` is insufficient
- Delivery: [backend/apps/billing/services/invoice_replacement_delivery.py](../../../backend/apps/billing/services/invoice_replacement_delivery.py) — storno uses `original.email_recipient`; replacement uses the frozen recipient email; post-commit only
- Tests: [backend/apps/billing/tests/test_invoice_replacement.py](../../../backend/apps/billing/tests/test_invoice_replacement.py), [test_invoice_replacement_model.py](../../../backend/apps/billing/tests/test_invoice_replacement_model.py), [test_invoice_replacement_service.py](../../../backend/apps/billing/tests/test_invoice_replacement_service.py), [test_invoice_replacement_storno.py](../../../backend/apps/billing/tests/test_invoice_replacement_storno.py), [test_invoice_replacement_complete.py](../../../backend/apps/billing/tests/test_invoice_replacement_complete.py), [test_invoice_replacement_delivery.py](../../../backend/apps/billing/tests/test_invoice_replacement_delivery.py), [test_invoice_replacement_api.py](../../../backend/apps/billing/tests/test_invoice_replacement_api.py)

Token-only admin writes are attributed to a tenant-scoped `admin-api.{slug}` staff user unless a staff session is also present. No `#1159` write in this slice.
